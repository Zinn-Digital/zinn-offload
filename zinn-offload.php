...
define( 'ZINN_OFFLOAD_VERSION', '1.2.2' );
...
require_once __DIR__ . '/includes/class-zinn-offload-updater.php'; // Generated by wp/bin/build-updater.php.
...
add_action(
	...
	static function (): void {
		...
		// The updater attaches whether or not the site is paired: an unpaired install still
		// needs security releases, and the check is one cached request every six hours.
		( new Zinn_Offload_Updater( ZINN_OFFLOAD_FILE, ZINN_OFFLOAD_VERSION ) )->register();
